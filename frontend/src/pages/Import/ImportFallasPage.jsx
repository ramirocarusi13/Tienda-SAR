...
export default function ImportFallasPage() {
    ...
    async function handleSubmit(event) {
        ...
        const data = await uploadImportFile("import/codigosfallas", formData)
    ...
    return (
        <div>
            <div className='bg-yellow-200 p-2'>
                <span className='font-semibold'>9-IMPORTAR CÓDIGO FALLAS (9-CodigosFallas.xls)</span>
            </div>
